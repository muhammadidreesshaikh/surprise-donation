...
export const cardsData = [
  ...
  },
  {
    ...
    location: "Austin, TX",
    description:
      "Hi everyone! I'm a single mom working two jobs to support my 8-year-old daughter. After an unexpected car repair bill of $1,200, I'm struggling to make ends meet this month. Any help with groceries or utilities would mean the world to us. Thank you for taking the time to read our story! ",
    userImg: img3,
    postImg: img6,
